...
namespace NewsFilter.Common
{
    /// <summary>
    /// Usage: 
    /// 1) In a XAML file, declare the above namespace, e.g.:
    ///    xmlns:common="using:NewsFilter.Common"
    ///     
    ...
    public class Properties : DependencyObject
    {
        ...
        private static async Task<string> ConvertHtmlToXamlRichTextBlock(string xhtml)
        {
            ...
            if (Html2XamlProcessor == null)
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("NewsFilter.Common.RichTextBlockHtml2Xaml.xslt"))
                {
